  ...
  <div class="contener">
    <div class="header">
            ...
            <div class="modal__inner">
              <div class="modal__header">
                <div class="modal__head">
                  <h5>Filter & Sort</h5>
                  <span><a onclick="closeFilter()" class="close">Clear All <i>&#x2715;</i></a></span>
                </div>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul class="sort_item-divi">
                        ...
                        <li>
                          <input class="check" type="checkbox" name="" id="" />Accessories<i>[348]</i>
                        </li>
                      </ul>
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul class="sort_item-sport">
                        ...
                        <li>
                          <input class="check" type="checkbox" name="" id="" />Golf<i>[348]</i>
                        </li>
                        <li>
                        ...
                        <li>
                          <input class="check" type="checkbox" />Others<i>[864]</i>
                        </li>
                      </ul>
                    </li>
                  </ul>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul class="sort_item-type">
                        ...
                        <li>
                          <input class="check" type="checkbox" name="" id="" />Slides & Flip Flops<i>[248]</i>
                        </li>
                        <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <ul class="sort_item-brand">
                        ...
                        <li>
                          <input class="check" type="checkbox" name="" id="" />Sportswear<i>[248]</i>
                        </li>
                        <li>
      ...
      <div class="item-all">
        ...
        $sql = "SELECT id,productname,price,description,image FROM product where categories='kid'";
