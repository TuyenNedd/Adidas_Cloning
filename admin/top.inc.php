         ...
         <header id="header" class="header">
            <div class="top-left">
               ...
               <div class="navbar-header">
                  ...
                  <!--<a class="navbar-brand" href="index.php"><img src="images/icon-adidas-logo.svg" alt="Logo"><b></b></a>-->
                  <a class="navbar-brand hidden" href="index.php"><img src="images/MyLogo.png" alt="Logo" ></a>
                  <a id="menuToggle" class="menutoggle"><img src="images/bars-solid.svg" alt=""></i></a>
               </div>
            </div>
            <div class="top-right">
