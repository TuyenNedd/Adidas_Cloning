					  ...
					  <table class="table ">
						 ...
						 <tbody>
							...
							<tr>
                               ...
                               <td><img src="imgproduct/<?php echo $row['image']?>" alt=""></td>
							   <td>
								<?php
								if($row['quantity']>=1){
									echo "<span class='badge badge-complete'><b>Out of stock</b></span>&nbsp;";
								}else{
									echo "<span class='badge badge-pending'><b>Stoking</b></span>&nbsp;";
								}
